...
def my_load_data(data_root, dataset, phase, batch_size, num_workers=4, shuffle=True):
    ...
    data_loader = DataLoader(dataset=set_, batch_size=batch_size,
...
def load_data(data_root, dataset, phase, batch_size, sampler_dic=None, num_workers=4, test_open=False, shuffle=True):
    ...
    if sampler_dic and phase == 'train':
        ...
        return DataLoader(dataset=set_, batch_size=batch_size, shuffle=shuffle,
