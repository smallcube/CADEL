...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', default="./config/Places_LT/ViT_B_16_384_stage2.yaml", type=str)
    ...
    for tao in taos:
        print('tao=', tao)
        rsl = training_model.eval(phase='val', tao=tao)
        if rsl['val_all'] > best_acc:
            best_acc = rsl['val_all']
            best_tao = tao
    print("bset_tao=", best_tao, "   best_acc=", best_acc)
    training_model.eval(phase='test', tao=best_tao)
