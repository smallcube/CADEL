...
from run_networks_CNN_Places365 import model
import warnings
import yaml
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', default="./config/Places_LT/resnet152_stage2.yaml", type=str)
