...
class ResNext(nn.Module):
    ...
    def __init__(self, block, layers, groups=1, width_per_group=64, dropout=None, num_classes=1000, normalized=False):
        self.inplanes = 64
        ...
        #self.aux_layer1 = Aux_Layer1(block.expansion*64, num_classes)
        self.aux_layer2 = Aux_Layer1(block.expansion*128, num_classes, normalized=normalized)
        self.aux_layer3 = Aux_Layer2(block.expansion*256, num_classes, normalized=normalized)
        ...
        if normalized:
            self.fc = CosNorm_Classifier(512*block.expansion, num_classes)
        else:
