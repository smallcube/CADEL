...
from models.Aux_Layers1 import *
...
class ResNext(nn.Module):
    ...
    def __init__(self, block, layers, groups=1, width_per_group=64,
        ...
        self.aux_layer2 = Aux_Layer1(block.expansion*128, num_classes, normalized=normalized, scale=scale, dropout=dropout)
        self.aux_layer3 = Aux_Layer2(block.expansion*256, num_classes, normalized=normalized, scale=scale, dropout=dropout)
